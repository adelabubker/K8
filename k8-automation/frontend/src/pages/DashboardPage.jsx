    ...
    <DashboardLayout>
      <div style={{ animation: 'fadeIn 0.4s ease' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '20px', marginBottom: '36px' }}>
          <StatCard icon={Zap} label="Total Services" value={stats.services} color="var(--accent-primary)" trend="+12%" />
          {isFullAdmin && <StatCard icon={Users} label="Total Users" value={stats.users} color="#a78bfa" trend="+5%" />}
          <StatCard icon={Activity} label="Active Workflows" value="24" color="#60a5fa" trend="+8%" />
