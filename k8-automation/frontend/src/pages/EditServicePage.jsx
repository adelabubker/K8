...
import { Save, ArrowLeft, Zap, ToggleLeft, ToggleRight } from 'lucide-react';
  ...
  useEffect(() => {
    const fetchService = async () => {
      try {
        ...
        setForm({ title: s.title, description: s.description, location: s.location, icon: s.icon || 'zap', isActive: s.isActive });
      } catch {
